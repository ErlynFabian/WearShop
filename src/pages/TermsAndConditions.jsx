    ...
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">1. Aceptación de los Términos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">2. Uso del Sitio Web</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">3. Productos y Precios</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">4. Pedidos y Pagos</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">5. Propiedad Intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">6. Limitación de Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">7. Indemnización</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">8. Ley Aplicable</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">9. Cambios a los Términos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 break-words">10. Contacto</h2>
            <p>

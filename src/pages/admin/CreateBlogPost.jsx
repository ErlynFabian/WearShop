...
const CreateBlogPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      useToastStore.getState().success(`Artículo "${formData.title}" creado correctamente`);
      navigate('/admin/blog');
    } catch (error) {
      useToastStore.getState().error('Error al crear el artículo');
    }
  };
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h2 className="text-5xl font-black text-black mb-2">Crear Artículo</h2>
        <p className="text-gray-600">Agrega un nuevo artículo al blog</p>
      </div>

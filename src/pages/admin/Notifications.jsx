...
import { FiBell, FiCheck, FiCheckCircle, FiTrash2, FiFilter, FiPackage, FiDollarSign, FiAlertTriangle, FiShoppingCart, FiInfo } from 'react-icons/fi';
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-5xl font-black text-black mb-2">Notificaciones</h2>
          <p className="text-gray-600">Gestiona todas tus notificaciones</p>
        </div>
        {unreadCount > 0 && (
          <button
            onClick={handleMarkAllAsRead}
            className="flex items-center space-x-2 bg-black text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition-opacity"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-sm text-gray-600 mb-2">Total de Notificaciones</p>
          <p className="text-3xl font-black text-black">{notifications.length}</p>
        </div>
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-sm text-gray-600 mb-2">No Leídas</p>
          <p className="text-3xl font-black text-yellow-600">{unreadCount}</p>
        </div>
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <p className="text-sm text-gray-600 mb-2">Leídas</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          <h3 className={`text-lg font-bold ${notification.read ? 'text-gray-700' : 'text-black'}`}>
                            {notification.title}
                          </h3>

...
const Accesorios = () => {
  ...
  const { typeLabels, orderedTypes } = useMemo(() => {
    const labels = {};
    const categoryTypes = types['accesorios'] || [];
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [selectedType, productsByType, accesoriosProducts, filters]);
  ...
  return (
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <SEO
        ...
        description="Complementa tu estilo con nuestra colección de accesorios. Bolsos, zapatos, relojes y más. Accesorios de calidad para completar tu look."
        keywords="accesorios, bolsos, zapatos, relojes, complementos, moda, estilo"
      />
      {loading ? (
      ...
      <div className="max-w-7xl mx-auto">
        <motion.h1
          ...
          className="text-[3.5rem] md:text-8xl font-black text-black mb-4"
        >
          ACCESORIOS
        </motion.h1>
        <motion.p
